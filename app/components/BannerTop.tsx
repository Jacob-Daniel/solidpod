...
export default function BannerTop({
	...
	return (
		<div className="col-span-12 px-5 lg:px-0 max-h-[330px] retina:max-h-[525px] md:max-h-[350px] hd:max-h-[390px]">
			<div
				style={{ backgroundColor: bg }}
				className={`col-span-12 relative dark:border dark:border-zinc-800 overflow-hidden max-h-[330px] retina:max-h-[525px] md:max-h-[350px] hd:max-h-[390px]`}
			>
				<div className="col-span-12">
					<div className="relative flex items-end justify-end overflow-hidden max-h-[300px] retina:max-h-[525px] md:max-h-[350px] hd:max-h-[390px]">
						<SVG
					...
					<div className="absolute z-30 inset-x-0 bottom-0 top-0 w-full flex items-center justify-start px-10 overflow-hidden bg-black/30 md:bg-transparent max-h-[300px] retina:max-h-[525px] md:max-h-[350px] hd:max-h-[390px]">
