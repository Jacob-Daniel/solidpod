		...
		<div className="col-span-12 px-5 lg:px-0 md:max-h-[350px] hd:max-h-[390px]">
			...
			>
				<div className="col-span-12">
					...
					<div
						className={`absolute z-30 inset-x-0 bottom-0 pb-7 md:top-0 w-full flex items-center justify-start px-10 overflow-hidden bg-gradient-to-t from-black/90 from-0% to-transparent to-110% md:bg-none md:max-h-[350px] hd:max-h-[390px]`}
					>
