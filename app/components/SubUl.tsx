...
export default function SubUl({ id, links, parentSlug }: ILinks) {
	...
	return (
		<ul
			className={`!z-50 mt-[5px] md:mt-0 md:absolute top-[55px] border border-gray-400 grid md:gap-x-5 items-center py-0 px-2 justify-center ${display} rounded py-1 bg-white dark:bg-zinc-800 dark:border-zinc-700`}
		>
			{links.map((link) => (
