...
export default async function Nav({ type }: { type: string }) {
	...
	return (
		<nav className="col-span-12 z-50 bg-transparent md:col-span-10 w-full grid grid-cols-12 justify-end md:align-middle px-5 md:h-[100px] md:items-center md:px-0">
