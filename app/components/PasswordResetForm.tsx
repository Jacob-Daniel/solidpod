...
const PasswordResetForm = () => {
	...
	return (
		<div className="p-5 border border-border rounded mt-5 flex flex-col">
			<button
				className="self-start border border-border font-bold rounded py-1 px-2 text-left cursor-pointer mb-3"
				...
				<div>
					...
					>
						<input
							...
							required
							className="border border-border px-1 w-full "
							autoComplete="new-pasword"
						/>
						{!message.includes("reset email sent") && (
							<button
								type="submit"
								className={`px-2 py-1 !flex-shrink cursor-pointer border border-border ${processing ? "bg-gray-400" : ""} rounded font-bold`}
							>
