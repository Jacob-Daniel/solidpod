...
const PasswordResetForm = () => {
	...
	return (
		<div className="p-5 border border-gray-300 dark:border-zinc-800 rounded mt-5 flex flex-col">
			<button
				className="self-start border border-gray-300 dark:border-zinc-800 font-bold rounded py-1 px-2 text-left cursor-pointer mb-3"
				...
				<div>
					...
					>
						...
						{!message.includes("reset email sent") && (
							<button
								type="submit"
								className={`px-2 py-1 !flex-shrink cursor-pointer border border-gray-300 dark:border-zinc-800 ${processing ? "bg-gray-400" : ""} rounded font-bold`}
							>
