...
const AccountForm = () => {
	...
	return (
		<form
			...
			className="flex flex-col gap-y-3 p-5 rounded w-full border border-gray-300 dark:border-zinc-800"
		>
			...
			<div className="text-left">
				<button
					type="submit"
					disabled={processing}
					className={`p-1 px-2 font-bold border border-gray-300 rounded cursor-pointer ${processing ? "bg-gray-400" : ""}`}
				>
