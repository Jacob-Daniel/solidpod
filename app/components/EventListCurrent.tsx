...
const Article: React.FC<Article> = ({
	...
	return (
		<article
			className={`border-gray-300 dark:border-zinc-500 border grid grid-cols-12 md:grid-cols-12 bg-white relative md:pb-0`}
		>
			...
			<div className="col-span-12 md:col-span-8 p-3">
				...
				<footer className="flex flex-col md:flex-wrap">
					...
					<a
						className="inline-block self-end  ps-1 pe-2 py-[1px] text-sm rounded text-black border border-gray-300 dark:border-zinc-500 md:absolute md:right-3 md:bottom-3"
						href={eventUrl}
					>
