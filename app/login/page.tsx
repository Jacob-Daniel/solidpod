...
export default async function Login() {
	...
	return (
		<main className="grid grid-cols-12 col-span-12 min-h-[500px]">
			<div className="col-span-12 grid grid-cols-12 col-span-12 px-5 lg:px-0 lg:col-start-2 lg:col-span-10">
				<section className="min-h-[100%] col-span-12 md:col-start-4 md:col-span-6 justify-center py-10">
